...
export class PageInfoService {
    ...
    public calculateTitleInMenu(menuId: string): string | undefined {
        ...
        const allActiveMenuLinks = Array.from<HTMLLinkElement>(menu.querySelectorAll('a.menu-link')).filter(link =>
    ...
    public calculateBreadcrumbsInMenu(menuId: string): Array<PageLink> | undefined {
        ...
        const allActiveParents = Array.from<HTMLDivElement>(menu.querySelectorAll('div.menu-item')).filter(link =>
