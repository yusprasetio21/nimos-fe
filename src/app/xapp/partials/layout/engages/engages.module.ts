...
@NgModule({
    declarations: [ExploreMainDrawerComponent, HelpDrawerComponent, PurchaseToolbarComponent],
    imports: [CommonModule, InlineSVGModule, RouterModule],
    exports: [ExploreMainDrawerComponent, HelpDrawerComponent, PurchaseToolbarComponent]
})
