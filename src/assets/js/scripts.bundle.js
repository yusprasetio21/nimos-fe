                ...
                'on' === String(document.body.getAttribute('data-kt-drawer-' + n.name + '-'))
                    ...
                    !0 === m('activate')
                        ...
                        : (KTUtil.removeClass(n.element, n.options.baseClass),
                          ...
                          o &&
                              (KTUtil.isRTL() ? KTUtil.css(n.element, 'right', '') : KTUtil.css(n.element, 'left', '')),
                          a &&
                              (KTUtil.isRTL() ? KTUtil.css(n.element, 'left', '') : KTUtil.css(n.element, 'right', '')),
                          l());
            },
            d = function () {
                !0 === m('overlay') &&
        ...
        var i = { dropdown: { hoverTimeout: 200, zindex: 105 }, accordion: { slideSpeed: 250, expand: !1 } },
            ...
            a = function (e) {
                e || (e = n.triggerElement),
                    !0 !== m(e) &&
                        ('dropdown' === v(e) ? U(e) : 'accordion' === v(e) && A(e), KTUtil.data(e).set('type', v(e)));
            },
            l = function (e) {
            ...
            s = function (e) {
                if (!1 !== f(e)) {
                    ...
                    KTUtil.data(e).has('type') &&
                        ...
                        (KTUtil.removeClass(e, 'hover'), KTUtil.removeClass(e, 'show'), KTUtil.removeClass(t, 'show'));
                }
            },
            u = function () {
            ...
            w = function (e) {
                if (!1 !== KTEventHandler.trigger(n.element, 'kt.menu.dropdown.hide', e)) {
                    ...
                    KTUtil.css(t, 'z-index', ''),
                        ...
                        !0 === L(e, 'overflow') &&
                            (e.classList.contains('menu-item') ? e.appendChild(t) : KTUtil.insertAfter(n.element, e),
        ...
        getResponsiveValue: function (e, t) {
            ...
            if ('object' == typeof (e = KTUtil.parseJson(e))) {
                var r,
                    ...
                    a = -1;
                for (var l in e)
                    (o = 'default' === l ? 0 : this.getBreakpoint(l) ? this.getBreakpoint(l) : parseInt(l)) <= i &&
                        o > a &&
                        ((r = l), (a = o));
                n = r ? e[r] : e;
            } else n = e;
                    ...
                    '1' !== e.getAttribute('data-kt-initialized') &&
                        (!(function (e) {
                            ...
                            const n = Object.assign(
                                {},
                                { container: e, slideBy: 'page', autoplay: !0, autoplayButtonOutput: !1 },
                                t
                            );
...
var KTThemeMode = (function () {
    var e,
        ...
        i = function (e) {
            return (
                'kt_' +
                (document.body.hasAttribute('data-kt-name') ? document.body.getAttribute('data-kt-name') + '_' : '') +
                'theme_mode_' +
                e
            );
        },
        ...
        a = function () {
            ...
            return n && n.getAttribute('data-kt-value')
                ? n.getAttribute('data-kt-value')
