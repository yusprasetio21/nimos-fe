        ...
        !(function () {
            ...
            if (e) {
                var t = e.getAttribute('data-kt-chart-color'),
                    ...
                    i = new ApexCharts(e, {
                        series: [
                            { name: 'Sales', data: [30, 75, 55, 45, 30, 60, 75, 50], margin: { left: 5, right: 5 } }
                        ],
                        chart: {
                            fontFamily: 'inherit',
                            type: 'bar',
        ...
        t = function (e) {
            ...
            if (t) {
                var a = parseInt(KTUtil.css(t, 'height')),
                    ...
                    o = {
                        series: [
                            { name: 'Sales', data: [3.5, 5.7, 2.8, 5.9, 4.2, 5.6, 4.3, 4.5, 5.9, 4.5, 5.7, 4.8, 5.7] }
                        ],
        ...
        t = function (e) {
            ...
            if (t) {
                var a = parseInt(KTUtil.css(t, 'height')),
                    ...
                    o = {
                        series: [
                            { name: 'Sales', data: [4.5, 5.7, 2.8, 5.9, 4.2, 5.6, 5.2, 4.5, 5.9, 4.5, 5.7, 4.8, 5.7] }
                        ],
                        chart: { fontFamily: 'inherit', type: 'area', height: a, toolbar: { show: !1 } },
                        legend: { show: !1 },
                        dataLabels: { enabled: !1 },
...
var KTChartsWidget11 = (function () {
    ...
    return {
        init: function () {
            var r = [
                16, 19, 19, 16, 16, 14, 15, 15, 17, 17, 19, 19, 18, 18, 20, 20, 18, 18, 22, 22, 20, 20, 18, 18, 20, 20,
                18, 20, 20, 22
            ];
            l(e, '#kt_charts_widget_11_tab_1', '#kt_charts_widget_11_chart_1', r, !1);
            var o = [
                18, 18, 20, 20, 18, 18, 22, 22, 20, 20, 18, 18, 20, 20, 18, 18, 20, 20, 22, 15, 18, 18, 17, 17, 15, 15,
                17, 17, 19, 17
            ];
            l(t, '#kt_charts_widget_11_tab_2', '#kt_charts_widget_11_chart_2', o, !1);
            var i = [
                17, 20, 20, 19, 19, 17, 17, 19, 19, 21, 21, 19, 19, 21, 21, 18, 18, 16, 17, 17, 19, 19, 21, 21, 19, 19,
                17, 17, 18, 18
            ];
                    ...
                    var t,
                        a = function () {
                            ...
                            var a = t.container.children.push(
                                am5xy.XYChart.new(t, { panX: !0, panY: !0, wheelX: 'panX', wheelY: 'zoomX' })
                            );
                            ...
                            o
                                ...
                                a.set(
                                    'scrollbarX',
                                    am5.Scrollbar.new(t, { orientation: 'horizontal', marginBottom: 25, height: 8 })
                                );
                ...
                if (e) {
                    var t,
                        a = function () {
                            (t = am5.Root.new(e)).setThemes([am5themes_Animated.new(t)]);
                            var a = t.container.children.push(
                                    am5xy.XYChart.new(t, { panX: !1, panY: !1, layout: t.verticalLayout })
                                ),
                                l =
                                    (a.get('colors'),
                                    [
                    ...
                    var t,
                        a = function () {
                            ...
                            var i = am5xy.AxisRendererY.new(t, { opposite: !0 }),
                                s = a.yAxes.push(
                                    am5xy.ValueAxis.new(t, { renderer: i, min: 0, max: 100, strictMinMax: !0 })
                                );
                            s
                                .get('renderer')
                                .labels.template.setAll({
                ...
                if (e) {
                    var t,
                        a = function () {
                                ...
                                l = [
                                    {
                                        ...
                                        income: 23.5,
                                        expenses: 21.1,
                                        columnSettings: { fill: am5.color(KTUtil.getCssVariableValue('--kt-primary')) }
                                    },
                                    {
                                        year: '2017',
                                        income: 26.2,
                            ...
                            i.columns.template.setAll({ tooltipY: am5.percent(10), templateField: 'columnSettings' }),
                                i.data.setAll(l);
                            var s = a.series.push(
                                am5xy.LineSeries.new(t, {
                                    name: 'Expenses',
                    ...
                    var t,
                        a = function () {
                            ...
                            var o = t.container.children.push(
                                am5.Container.new(t, { layout: t.horizontalLayout, width: am5.p100, height: am5.p100 })
                            );
                ...
                if (e) {
                    var t,
                        a = function () {
                            ...
                            var r = a.xAxes.push(
                                    am5xy.CategoryAxis.new(t, { maxDeviation: 0, categoryField: 'name', renderer: l })
                                ),
                            ...
                            var d = a.radarContainer.children.push(
                                am5.Legend.new(t, { width: 150, centerX: am5.p50, centerY: am5.p50 })
                            );
                            d.data.setAll([s, n]),
                ...
                if (e) {
                    var t,
                        ...
                        l = function () {
                            ...
                            var r = t.xAxes.push(
                                    am5xy.CategoryAxis.new(a, { maxDeviation: 0, categoryField: 'name', renderer: l })
                                ),
                            ...
                            var d = t.radarContainer.children.push(
                                am5.Legend.new(a, { width: 150, centerX: am5.p50, centerY: am5.p50 })
                            );
                            d.data.setAll([s, n]),
                                d.labels.template.setAll({
                                    fontWeight: '600',
                    ...
                    n = {
                        series: [
                            ...
                            },
                            {
                                name: 'Outbound Calls',
                                data: [
                                    90, 110, 110, 95, 95, 85, 85, 95, 95, 115, 115, 100, 100, 115, 115, 95, 95, 85, 85
                                ]
                            }
                        ],
                        chart: { fontFamily: 'inherit', type: 'area', height: a, toolbar: { show: !1 } },
            ...
            var a = parseInt(KTUtil.css(t, 'height')),
                ...
                r = {
                    ...
                    xaxis: {
                        ...
                        axisBorder: { show: !1 },
                        axisTicks: { show: !1 },
                        labels: { style: { colors: KTUtil.getCssVariableValue('--kt-gray-700'), fontSize: '12px' } }
                    },
                    yaxis: {
                        labels: { style: { colors: KTUtil.getCssVariableValue('--kt-gray-700'), fontSize: '12px' } }
                    },
                    ...
                    var t,
                        a = function () {
                            ...
                            var a = t.container.children.push(
                                ...
                                l = a.series.push(
                                    am5map.MapPolygonSeries.new(t, { geoJSON: am5geodata_worldLow, exclude: ['AQ'] })
                                );
            ...
            t.addEventListener('timeupdate', function () {
                ...
                o.addEventListener('click', function () {
                    t.duration > 0 && !t.paused
                        ...
                        : t.readyState >= 2 && (t.play(), i.classList.add('d-none'), s.classList.remove('d-none'));
                }),
                n.addEventListener('click', function () {
                    t.readyState >= 2 &&
                        ((t.currentTime = 0), t.play(), i.classList.add('d-none'), s.classList.remove('d-none'));
                }),
